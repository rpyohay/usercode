...
\begin{figure}
	\centering
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$.]{\label{fig:sig_xsec_mgluino_vs_msquark_bino}\includegraphics[scale=0.3]{can_xsec_bino_mN375_met100_nojet}}
	\\
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$.]{\label{fig:sig_xsec_mgluino_vs_msquark_wino}\includegraphics[scale=0.3]{can_xsec_wino_mN375_met100_nojet}}
	\\
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$.]{\label{fig:sig_xsec_mgluino_vs_mbino_old}\includegraphics[scale=0.3]{can_xsec_bino_mNScan_met100_nojet}}
...
%	\\
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:sig_Axe_mgluino_vs_msquark_bino}\includegraphics[scale=0.3]{mgluino_vs_msquark_METGeq50GeV_bino_old}}
	\hspace{1cm}
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:sig_Axe_mgluino_vs_msquark_bino_1jet}\includegraphics[scale=0.3]{mgluino_vs_msquark_METGeq50GeV_bino_old_1jet}}
	\\
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:sig_Axe_mgluino_vs_msquark_wino}\includegraphics[scale=0.3]{mgluino_vs_msquark_METGeq50GeV_wino_old}}
	\hspace{1cm}
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:sig_Axe_mgluino_vs_msquark_wino_1jet}\includegraphics[scale=0.3]{mgluino_vs_msquark_METGeq50GeV_wino_old_1jet}}
	\\
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq0$ jets.]{\label{fig:sig_Axe_mgluino_vs_mbino_old}\includegraphics[scale=0.3]{mgluino_vs_mbino_METGeq50GeV_old}}
	\hspace{1cm}
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq1$ jet.]{\label{fig:sig_Axe_mgluino_vs_mbino_old_1jet}\includegraphics[scale=0.3]{mgluino_vs_mbino_METGeq50GeV_old_1jet}}
...
To estimate the uncertainty due to imperfect simulation of LHC pileup, the square of the average data efficiency for photons over the range 1-15 reconstructed primary vertices (see Fig.~\subref*{fig:eff_vs_NPV}), weighted by the number of $\gamma\gamma$ events per primary vertex bin, is calculated.  The efficiency per primary vertex bin is estimated from a linear fit to Fig.~\subref*{fig:eff_vs_NPV}.  The process is repeated for MC using the entire range of primary vertices in Fig.~\subref*{fig:eff_vs_NPV} (all MC signal points have the same pileup simulation).  The error is taken as 2 $\times$ $|$ avg. data efficiency squared - avg. MC efficiency squared $|$/(avg. data efficiency squared + avg. MC efficiency squared).
...
\begin{figure}
	\centering
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:xsec_UL_mgluino_vs_msquark_bino}\includegraphics[scale=0.3]{can_limit_bino_mN375_met100_nojet}}
	\hspace{1cm}
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:xsec_UL_mgluino_vs_msquark_bino_1jet}\includegraphics[scale=0.3]{can_limit_bino_mN375_met100_1jet}}
	\\
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:xsec_UL_mgluino_vs_msquark_wino}\includegraphics[scale=0.3]{can_limit_wino_mN375_met100_nojet}}
	\hspace{1cm}
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:xsec_UL_mgluino_vs_msquark_wino_1jet}\includegraphics[scale=0.3]{can_limit_wino_mN375_met100_1jet}}
	\\
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq0$ jets.]{\label{fig:xsec_UL_mgluino_vs_mbino_old}\includegraphics[scale=0.3]{can_limit_bino_mNScan_met100_nojet}}
	\hspace{1cm}
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq1$ jet.]{\label{fig:xsec_UL_mgluino_vs_mbino_old_1jet}\includegraphics[scale=0.3]{can_limit_bino_mNScan_met100_1jet}}
...
\begin{figure}
	\centering
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:exclusion_contours_mgluino_vs_msquark_bino}\includegraphics[scale=0.3]{can_excl02_bino_mN375_met100_nojet}}
	\hspace{1cm}
	\subfloat[$M_{2}$ decoupled ($M_{2}$ = 3.5 TeV), $M_{1}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:exclusion_contours_mgluino_vs_msquark_bino_1jet}\includegraphics[scale=0.3]{can_excl02_bino_mN375_met100_1jet}}
	\\
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq0$ jets.]{\label{fig:exclusion_contours_mgluino_vs_msquark_wino}\includegraphics[scale=0.3]{can_excl02_wino_mN375_met100_nojet}}
	\hspace{1cm}
	\subfloat[$M_{1}$ decoupled ($M_{1}$ = 3.5 TeV), $M_{2}$ = 375 GeV, $M_{3}$ vs. $m_{\tilde{q}}$, $\geq1$ jet.]{\label{fig:exclusion_contours_mgluino_vs_msquark_wino_1jet}\includegraphics[scale=0.3]{can_excl02_wino_mN375_met100_1jet}}
	\\
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq0$ jets.]{\label{fig:exclusion_contours_mgluino_vs_mbino_old}\includegraphics[scale=0.3]{can_excl02_bino_mNScan_met100_nojet}}
	\hspace{1cm}
	\subfloat[$m_{\tilde{q}}$ decoupled ($m_{\tilde{q}}$ = 2.5 TeV), $M_{3}$ vs. $M_{1}$, $\geq1$ jet.]{\label{fig:exclusion_contours_mgluino_vs_mbino_old_1jet}\includegraphics[scale=0.3]{can_excl02_bino_mNScan_met100_1jet}}
