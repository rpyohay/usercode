...
where $i$ runs over all supermultiplets in Table~\ref{chiral_supermultiplets}, $M^{ij}$ is a mass matrix for the fermions, $y^{ijk}$ are the Yukawa couplings between one scalar and two spinor fields, and $V_{chiral}(\phi, \phi^{*}$ is the scalar potential
