...
The following introduction to SUSY focuses primarily on the aspects of the formalism that are relevant to phenomenology.  In particular, most of the details of SUSY breaking (about which there is little theoretical consensus) are omitted, except where they are relevant to experiment.  The notation is similar to that used in refs.~\ref{SUSY_primer} and~\ref{Aitchison}.
...
\begin{figure}
	\centering
	\subfloat[Fermion mass terms.  Reprinted from Figs. 3.2(c) and 3.2(d) of ref.~\ref{SUSY_primer}.]{\label{fig:fermion_mass_terms}\includegraphics[scale=1.35]{fermion_mass_terms}}
	\hspace{1cm}
	\subfloat[Sfermion mass terms.  Reprinted from Fig. 3.2(e) of ref.~\ref{SUSY_primer}.]{\label{fig:sfermion_mass_term}\includegraphics[scale=1.35]{sfermion_mass_term}}
	\\
	\subfloat[$A\phi\phi$ vertex.  Reprinted from Fig. 3.3(e) of ref.~\ref{SUSY_primer}.]{\label{fig:Aphiphi_vertex}\includegraphics[scale=1.8]{Aphiphi_vertex}}
	\hspace{1cm}
	\subfloat[$A\psi\psi$ vertex.  Reprinted from Fig. 3.3(f) of ref.~\ref{SUSY_primer}.]{\label{fig:Apsipsi_vertex}\includegraphics[scale=1.8]{Apsipsi_vertex}}
	\hspace{1cm}
	\subfloat[$A\lambda\lambda$ vertex.  Reprinted from Fig. 3.3(c) of ref.~\ref{SUSY_primer}.]{\label{fig:Alambdalambda_vertex}\includegraphics[scale=1.8]{Alambdalambda_vertex}}
	\\
	\subfloat[Triple gauge boson vertex.  Reprinted from Fig. 3.3(b) of ref.~\ref{SUSY_primer}.]{\label{fig:triple_gauge_boson_vertex}\includegraphics[scale=1.62]{triple_gauge_boson_vertex}}
	\hspace{1cm}
	\subfloat[Triple sfermion vertices.  Reprinted from Figs. 3.2(a) and 3.2(b) of ref.~\ref{SUSY_primer}.]{\label{fig:triple_sfermion_vertices}\includegraphics[scale=1.62]{triple_sfermion_vertices}}
	\\
	\subfloat[Cubic couplings in which the fermion radiates a sfermion.  Reprinted from Figs. 3.1(a) and 3.1(b) of ref.~\ref{SUSY_primer}.]{\label{fig:phipsipsi_vertices}\includegraphics[scale=1.07]{phipsipsi_vertices}}
	\hspace{1cm}
	\subfloat[Sfermion-fermion-gaugino vertices.  Reprinted from Figs. 3.3(g) and 3.3(h) of ref.~\ref{SUSY_primer}.]{\label{fig:phipsilambda_vertices}\includegraphics[scale=1.07]{phipsilambda_vertices}}
	\\
	\subfloat[$AA\phi\phi$ vertex.  Reprinted from Fig. 3.3(d) of ref.~\ref{SUSY_primer}.]{\label{fig:AAphiphi_vertex}\includegraphics[scale=1.22]{AAphiphi_vertex}}
	\hspace{1cm}
	\subfloat[Quadruple gauge boson vertex.  Reprinted from Fig. 3.3(a) of ref.~\ref{SUSY_primer}.]{\label{fig:quadruple_gauge_boson_vertex}\includegraphics[scale=1.22]{quadruple_gauge_boson_vertex}}
	\hspace{1cm}
	\subfloat[Non-gauge $\phi^{4}$ vertex.  Reprinted from Fig. 3.1(c) of ref.~\ref{SUSY_primer}.]{\label{fig:non-gauge_phi4_vertex}\includegraphics[scale=1.22]{non-gauge_phi4_vertex}}
	\hspace{1cm}
	\subfloat[Gauge $\phi^{4}$ vertex.  Reprinted from Fig. 3.3(i) of ref.~\ref{SUSY_primer}.]{\label{fig:gauge_phi4_vertex}\includegraphics[scale=1.22]{gauge_phi4_vertex}}
