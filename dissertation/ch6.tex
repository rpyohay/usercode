...
%get L1 spike rejection citation
...
\begin{figure}
	\centering
	\subfloat[Data.]{\label{fig:low_ET_bin_data}\includegraphics[scale=0.35]{low_ET_bin_data}}
	\hspace{1cm}
	\subfloat[MC.  The purple points are the background MC (photon + jet, $W$, QCD, and $t\bar{t}$).]{\label{fig:low_ET_bin_MC}\includegraphics[scale=0.35]{low_ET_bin_MC}}
...
\begin{figure}
	\centering
	\subfloat[Data.]{\label{fig:mid-eta_bin_data}\includegraphics[scale=0.35]{mid-eta_bin_data}}
	\hspace{1cm}
	\subfloat[MC.  The purple points are the background MC (photon + jet, $W$, QCD, and $t\bar{t}$).]{\label{fig:mid-eta_bin_MC}\includegraphics[scale=0.35]{mid-eta_bin_MC}}
