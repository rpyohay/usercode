...
%include the parts about tracker material?
...
%are the scintillator layers right?
...
%get no. time slices per tower per trigger in 2011
...
\begin{figure}
	\centering
 	\subfloat[Data/MC comparison of HB response to charged tracks of 9-11 GeV/$c$ momentum \cite{CMS-DP-2010-025}.]{\label{fig:HCAL_performance_HB_response}\includegraphics[scale=0.4]{HCAL_performance_HB_response}}
	\hspace{1cm}
	\subfloat[Distribution of tower multiplicity, clearly showing three peaks in rate corresponding to noise sources (see Sec.~\ref{sec:Event Quality}) \cite{HCAL_noise_CRAFT}.]{\label{fig:HCAL_performance_noise}\includegraphics[scale=0.4]{HCAL_performance_noise}}
	\hspace{1cm}
	\subfloat[Timing resolution vs. tower energy \cite{CMS-DP-2010-025}.]{\label{fig:HCAL_performance_timing}\includegraphics[scale=0.4]{HCAL_performance_timing}}
...
%insert reference to L1 jet finding algorithm
%do L1 seeds for double-photon paths have to be isolated?
