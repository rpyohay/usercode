...
rfcp DIR_JSON_HLT_PV_skim_v2_JOB.txt $CASTOR_HOME
rfcp DIR_JSON_HLT_PV_skim_v2_JOB.root $CASTOR_HOME
rm DIR_JSON_HLT_PV_skim_v2_JOB.txt DIR_JSON_HLT_PV_skim_v2_JOB.root susyEvent* ana_standalone_MC_JOB.C*
