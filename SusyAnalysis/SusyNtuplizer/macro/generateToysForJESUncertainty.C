#include "/afs/cern.ch/user/y/yohay/scratch0/CMSSW_4_2_4_patch2/src/GMSBTools/Filters/interface/Typedefs.h"

void generateToysForJESUncertainty_TOY()
{
  ...
  gSystem->Load("/afs/cern.ch/user/y/yohay/scratch0/CMSSW_4_2_4_patch2/src/PhysicsTools/lib/libUtilities.so");
  gSystem->Load("/afs/cern.ch/user/y/yohay/scratch0/CMSSW_4_2_4_patch2/src/PhysicsTools/lib/libTagAndProbe.so");
...
//   gROOT->LoadMacro("SusyEventPrinter.cc++");
  gSystem->SetIncludePath("-I/afs/cern.ch/user/y/yohay/scratch0/CMSSW_4_2_4_patch2/src -I/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/roofit/5.28.00a-cms7/include");
//   gROOT->LoadMacro("GMSBAnalyzer.C++");
  gSystem->Load("/afs/cern.ch/user/y/yohay/scratch0/CMSSW_4_2_4_patch2/src/SusyAnalysis/SusyNtuplizer/macro/GMSBAnalyzer_C.so");

  //instantiate GMSBAnalyzer object
  vector<string> input;
  input.push_back("4684pb-1_categorized_18-Jan-12_skim_v2.root");
  ...
  analyzer.setJESUncertaintyMode(true);
  analyzer.setJESUncertaintyShift(SHIFT);

  //loop over events
  TStopwatch ts;
  ts.Start();
  analyzer.runMETAnalysis("4684pb-1_MET_18-Jan-12_skim_JESUncertainty_nominalBins_TOY.root");
  ts.Stop();
