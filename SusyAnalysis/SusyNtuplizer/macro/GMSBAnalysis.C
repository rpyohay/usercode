...
//   gSystem->Load("SusyEventPrinter_cc.so");
  ...
  vector<string> input;
  input.push_back("/data2/yohay/RA3/4684pb-1_categorized_18-Jan-12_skim.root");
  ...
  TStopwatch ts;
  ts.Start();
  analyzer.runMETAnalysis("/data2/yohay/RA3/4684pb-1_MET_18-Jan-12_skim_R9_check.root");
