...
// $Id: SusyEvent.h,v 1.6 2012/02/07 22:13:44 yohay Exp $
//
...
namespace susy {
  ...
  public:
    ...
    ~Vertex() { Init(); }
    void Init();
    bool isFake() const { return (chi2 == 0 && ndof == 0 && tracksSize == 0); }
  ...
  public:
    ...
    Float_t hcalTowerSumEtConeDR04() const
    {
      return (hcalDepth1TowerSumEtConeDR04+hcalDepth2TowerSumEtConeDR04);
    }
    Float_t hcalTowerSumEtConeDR03() const
    {
      return (hcalDepth1TowerSumEtConeDR03+hcalDepth2TowerSumEtConeDR03);
    }
  ...
  public:
    ...
    // muon type
    bool isGlobalMuon() const {     return (type & (0x1 << 1)); }
    bool isTrackerMuon() const {    return (type & (0x1 << 2)); }
    bool isStandAloneMuon() const { return (type & (0x1 << 3)); }
    bool isCaloMuon() const {       return (type & (0x1 << 4)); }
