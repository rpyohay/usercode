...
JetCorrectorParameters const & JetCorrectorParametersCollection::operator[]( key_type k ) const {
  ...
  //shouldn't get here, just to remove compiler warnings
  std::cout << "Error: reached end of JetCorrectorParameters const & JetCorrectorParametersCollection::operator[]( key_type k ) const.\n";
  return correctionsL5_.begin()->second;
...
JetCorrectorParametersCollection::findKey( std::string const & label ) const {
  ...
  //shouldn't get here; just to remove compiler warnings
  std::cout << "Error: reached end of JetCorrectorParametersCollection::key_type JetCorrectorParametersCollection::findKey( std::string const & label ) const.\n";
  return getL5Bin(*(l5Flavors_.begin()));
