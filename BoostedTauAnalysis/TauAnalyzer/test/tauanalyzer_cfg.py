...
##     'file:/data1/yohay/Wh1_Medium/Wh1_Medium_selected_events_0.root'
    'file:/data1/yohay/WJets_Medium/WJets_Medium_selected_events_job1.root',
    'file:/data1/yohay/WJets_Medium/WJets_Medium_selected_events_job2.root'
    ])
...
process.muHadIsoTauAnalyzer = cms.EDAnalyzer(
    'TauAnalyzer',
##     outFileName = cms.string('/data1/yohay/Wh1_Medium/muHadAnalysisV3.root'),
    outFileName = cms.string('/data1/yohay/WJets_Medium/muHadAnalysisV4.root'),
...
#path
process.p = cms.Path(process.genPartonSelector*process.muHadIsoTauAnalyzer)
